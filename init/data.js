const sampleListings = [
    {
      ...
      geometry: {
        type: "Point",
        coordinates: [-118.788193, 34.031246], // Coordinates for Malibu, USA
      },
      category: "Bnb-Rooms", // Added category
    },
    {
      ...
      geometry: {
        type: "Point",
        coordinates: [-74.0060, 40.7128], // Coordinates for New York City, USA
      },
      category: "Bnb-City", // Added category
    },
    {
      ...
      geometry: {
        type: "Point",
        coordinates: [-106.8370, 39.1911], // Coordinates for Aspen, USA
      },
      category: "Bnb-Hills", // Added category
    },
    {
    ...
    },
   {
        ...
        geometry: {
          type: "Point",
          coordinates: [-120.044, 39.0968], // Coordinates for Lake Tahoe, USA
        },
        category: "Bnb-Hills", // Added category
      },
      {
      ...
      },
      {
        ...
        geometry: {
          type: "Point",
          coordinates: [7.2331, 46.0937], // Coordinates for Verbier, Switzerland
        },
        category: "Bnb-Hills", // Added category
      },
      {
        ...
        geometry: {
          type: "Point",
          coordinates: [34.8233, -2.3333], // Coordinates for Serengeti National Park, Tanzania
        },
        category: "Bnb-Rooms", // Added category
      },
      {
        ...
        geometry: {
          type: "Point",
          coordinates: [4.9041, 52.3676], // Coordinates for Amsterdam, Netherlands
        },
        category: "Bnb-City", // Added category
      },
      {
      ...
      },
     {
        ...
        geometry: {
          type: "Point",
          coordinates: [-1.7201, 51.8330], // Coordinates for Cotswolds, UK
        },
        category: "Bnb-Hills", // Added category
      },
      {
      ...
      },
      {
        ...
        geometry: {
          type: "Point",
          coordinates: [98.3381, 7.8804], // Coordinates for Phuket, Thailand
        },
        category: "Bnb-Rooms", // Added category
      },
      {
        ...
        geometry: {
          type: "Point",
          coordinates: [-4.2026, 57.1200], // Coordinates for Scottish Highlands, UK
        },
        category: "Bnb-Hills", // Added category
      },
      {
      ...
      },
      {
        ...
        geometry: {
          type: "Point",
          coordinates: [-110.3626, 46.8797], // Coordinates for Montana, USA
        },
        category: "Bnb-Hills", // Added category
      },
      {
        ...
        geometry: {
          type: "Point",
          coordinates: [25.3450, 37.4467], // Coordinates for Mykonos, Greece
        },
        category: "Bnb-Rooms", // Added category
      },
      {
        ...
        geometry: {
          type: "Point",
          coordinates: [-84.0739, 9.7489], // Coordinates for Costa Rica
        },
        category: "Bnb-Rooms", // Added category
      },
      {
      ...
      },
      {
        ...
        geometry: {
          type: "Point",
          coordinates: [-71.5724, 43.1939], // Coordinates for New Hampshire, USA
        },
        category: "Bnb-Hills", // Added category
      },
      {
      ...
      },
      {
        ...
        geometry: {
          type: "Point",
          coordinates: [-106.837, 39.1911], // Coordinates for Aspen, CO, USA
        },
        category: "Bnb-Hills", // Added category
      },
      {
